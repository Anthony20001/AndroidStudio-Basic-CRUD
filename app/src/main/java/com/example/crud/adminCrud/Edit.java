...
public class Edit extends AppCompatActivity {
    ...
    ArrayList<EditText> input_list = new ArrayList<EditText>();

    private EditText input_username, input_email, input_password, input_isAdmin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input_isAdmin = findViewById(R.id.edit_input_typeUser);
